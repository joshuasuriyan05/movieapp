...
const Home = () => {
  ...
  useEffect(() => {
    let url = `https://api.themoviedb.org/3/movie/popular?page=${page}&api_key=5e6186824571d09ba9809df0681d5739`;
    if(search) {
      url = `https://api.themoviedb.org/3/search/movie?query=${search}&api_key=5e6186824571d09ba9809df0681d5739`;
    }
    fetch(url)
